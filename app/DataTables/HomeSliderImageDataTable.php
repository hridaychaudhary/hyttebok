...
class HomeSliderImageDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('image', function ($data) {
                    $url=asset(config('fast.home_slider_image').'/'.$data->image); 
                    return '<img src='.$url.' border="0" width="40" class="img-rounded" align="center" />'; 
                })
                ->addColumn('action', 'admin.homeSliderImage.datatables_actions')
     ...
     *
     * @param \App\Models\HomeSliderImage $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(HomeSliderImage $model)
    {
